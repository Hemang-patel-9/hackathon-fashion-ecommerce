...
const recentCustomers = [
    { id: 1, name: 'Jay Vegad', date: '2024-01-15', amount: 299, avatar: '/avatars/01.png' },
                                ...
                                <div className="grid grid-cols-4 gap-4 mt-4">
                                    {product.images.map((image, index) => (
                                        <button
                                            ...
                                            className={`aspect-square rounded-md overflow-hidden border-2 ${selectedImage === index ? 'border-blue-500' : 'border-transparent'
                                                }`}
                                        >
                                            <img
                                                src={image}
